...
I histogrammet med n=8 kan er se stor variasjon innad i utvalgene. Ved de 1000 simuleringene som er gjort er det sannsynlig at det har vært stor spredning i de variablene som er trekt i samme utvalg (og motsatt). Dermed vil disse enkelt-utvalgene gjøre utslag på *p*-verdien begge veier.
...
## Ved å benytte det nye datasettet over: hvor mange tilfeller av "falsk positive"-tester vil vi komme over ved å repetere studien mange ganger?
