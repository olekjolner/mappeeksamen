...
## Metode - gjennomføring av V&#755;O~2max~ test
...
#| message: false
#| echo: false
#| label: plot av w.max for hver id ved de ulike tidspunkt for testing

# endret graf fra VO2.max og w.max, til å se på hver enkelt id sine variasjoner i w.max ved ulike testtidspunkt. Her kan man se på spredningen mellom hver test og da allerede få et innblikk i standardavvik. 
...
ggplot(data = df_all, 
  ...
  labs(x = "Testdeltakere", 
       y = "Max watt (W)", 
       subtitle = "Max watt testdeltaker hadde ved de ulike tidspunktene") 
